...
(iffi:defifun ("__claw__Z14SkStrAppendS64Pcxi"
...
(iffi:defifun ("__claw__Z14SkStrAppendU64Pcyi"
...
(iffi:deficlass (%skia::std+vector<int+std+allocator<int>>
                ...
                nil
                "/usr/include/c++/10.2.0/bits/stl_vector.h:389:11")

(iffi:defifun ("__claw__ZN22GrDriverBugWorkaroundsC1ERKSt6vectorIiSaIiEE"
               %skia::gr-driver-bug-workarounds)
              :void
...
(iffi:deficlass (%skia::std+map<unsigned+int+sk-sp<gr-cc-per-ops-task-paths>+std+less<unsigned+int>+std+allocator<std+pair<const+unsigned+int+sk-sp<gr-cc-per-ops-task-paths>>>>
                ...
                nil
                "/usr/include/c++/10.2.0/bits/stl_map.h:100:11")
...
(iffi:defifun ("__claw__ZN7SkImage25asyncRescaleAndReadPixelsERK11SkImageInfoRK7SkIRectNS_12RescaleGammaENS_11RescaleModeEPFvPvSt10unique_ptrIKNS_15AsyncReadResultESt14default_deleteISB_EEES8_"
...
(iffi:defifun ("__claw__ZN7SkImage31asyncRescaleAndReadPixelsYUV420E15SkYUVColorSpace5sk_spI12SkColorSpaceERK7SkIRectRK7SkISizeNS_12RescaleGammaENS_11RescaleModeEPFvPvSt10unique_ptrIKNS_15AsyncReadResultESt14default_deleteISF_EEESC_"
...
(iffi:deficlass (%skia::std+initializer-list<sk-point> :size-reporter
                ...
                nil
                "/usr/include/c++/10.2.0/initializer_list:47:11")
...
(iffi:deficlass (%skia::std+basic-string<char> :size-reporter
...
(iffi:defitype %skia::std+string
               %skia::std+basic-string<char>
               "/usr/include/c++/10.2.0/bits/stringfwd.h:79:33")

(iffi:defifun ("__claw__ZN8SkStringC1ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE"
               %skia::sk-string)
              :void
...
(iffi:defifun ("__claw__ZN8SkString9appendS64Exi" %skia::append-s64)
              :void
...
(iffi:defifun ("__claw__ZN8SkString9appendU64Eyi" %skia::append-u64)
              :void
...
(iffi:defistruct (%skia::std+--va-list :size-reporter
                  "__claw_sizeof_std___va_list" :alignment-reporter
                  "__claw_alignof_std___va_list")
                 nil
                 ":0:0")

(iffi:defitype %skia::va-list
               %skia::std+--va-list
               "/usr/include/stdio.h:52:24")

(iffi:defifun ("__claw__ZN8SkString12appendVAListEPKcSt9__va_list"
               %skia::append-va-list)
              :void
              "/home/borodust/devel/repo/claw-skia/src/lib/skia/include/core/SkString.h:220:10"
              (%skia::%%claw-this- (:pointer %skia::sk-string))
              (%skia::format (:pointer :char))
              (%skia::arg1 (:pointer %skia::va-list)))
...
(iffi:defifun ("__claw__ZN8SkString9insertS64Emxi" %skia::insert-s64)
              :void
...
(iffi:defifun ("__claw__ZN8SkString9insertU64Emyi" %skia::insert-u64)
              :void
...
(iffi:defifun ("__claw__ZN8SkString13prependVAListEPKcSt9__va_list"
               %skia::prepend-va-list)
              :void
...
(iffi:defifun ("__claw__ZN8SkString11printVAListEPKcSt9__va_list"
               %skia::print-va-list)
              :void
...
(iffi:defifun ("__claw__ZL11SkLeftShiftxi" %skia::sk-left-shift)
              %skia::int64-t
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export '%skia::prepend-va-list "%SKIA")
  ...
  (export '%skia::std+basic-string<char> "%SKIA")
  ...
  (export '%skia::append-va-list "%SKIA")
  ...
  (export '%skia::print-va-list "%SKIA")
