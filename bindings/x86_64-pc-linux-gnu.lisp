...
(defparameter %skia::+gr-file-and-line-str+ "/tmp/tmp16CY5V55-tmp.h(13) : ")
...
(iffi:defistruct (%skia::gr-context-options :size-reporter
                 ...
                 (%skia::f-glyphs-as-paths-font-size :float :setter
                  ...
                  :documentation
                  "/home/borodust/devel/repo/aw-projects/aw-skia/src/lib/skia/include/gpu/GrContextOptions.h:160:11")
...
(iffi:deficlass (%skia::std+array<float+4> :size-reporter
                ...
                (%skia::%%elems- (:pointer :float) :setter nil
                 :getter "__claw_get_std_array_float_4____elems_"
                 :documentation "/usr/include/c++/v1/array:148:9"))
